...
function BlogCard({ post, index }: { post: BlogPostData; index: number }) {
  return (
    ...
    >
      <Card className="bg-zinc-900/50 border-zinc-800 overflow-hidden group hover:border-emerald-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/5 hover:-translate-y-1 h-full flex flex-col">
        {/* Cover Image */}
        {post.coverImage && (
...
export default function BlogSection({ posts }: BlogSectionProps) {
  ...
  return (
    <section id="blog" className="py-20 px-4 md:px-8 lg:px-16 bg-black">
